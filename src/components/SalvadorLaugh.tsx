        ...
        {!envelopeOpen ? (
          ...
          >
            <button
              ...
              className="group relative w-full touch-manipulation text-left focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--accent)]"
              aria-expanded={false}
              aria-label="Abrir el sobre: regalo final"
            >
              <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[var(--sand)]/90 via-[var(--cream)] to-[var(--accent)]/[0.12] shadow-[0_24px_70px_-40px_rgba(90,60,40,0.32)] ring-1 ring-[var(--accent)]/30 transition group-hover:ring-[var(--accent)]/45">
                <div
                  className="pointer-events-none absolute inset-0 opacity-[0.45]"
                  style={{
                    backgroundImage:
                      "repeating-linear-gradient(-12deg, transparent, transparent 11px, rgba(90,60,40,0.04) 11px, rgba(90,60,40,0.04) 12px)",
                  }}
                  aria-hidden
                />
                {/* Solapa del sobre */}
                <div
                  className="relative z-[1] mx-auto flex h-[4.5rem] w-[92%] items-end justify-center sm:h-[5rem]"
                  aria-hidden
                >
                  <div
                    className="h-full w-full bg-gradient-to-b from-[#e5dccf] to-[var(--sand)] shadow-[inset_0_-8px_12px_rgba(90,60,40,0.08)]"
                    style={{
                      clipPath: "polygon(0 0, 50% 72%, 100% 0)",
                    }}
                  />
                </div>
                <div className="relative z-[2] -mt-px border-x border-b border-[var(--accent)]/20 bg-[var(--cream)]/95 px-8 pb-10 pt-2 text-center shadow-[inset_0_2px_24px_rgba(90,60,40,0.06)] sm:px-10 sm:pb-12">
                  <div
                    className="mx-auto mb-6 flex h-12 w-12 items-center justify-center rounded-full bg-[var(--accent)]/15 ring-2 ring-[var(--accent)]/25 transition group-hover:bg-[var(--accent)]/22"
                    aria-hidden
                  >
                    <Heart
                  ...
                  <p className="font-serif text-2xl leading-snug text-[var(--ink)] sm:text-[1.65rem]">
                    {clip.envelopeTitle}
                  </p>
                  <p className="mt-4 text-sm leading-relaxed text-[var(--muted)] sm:text-base">
                    {clip.envelopeSubtitle}
                  </p>
                  <p className="mt-10 font-serif text-xs uppercase tracking-[0.22em] text-[var(--accent)]">
                    Toca para abrir
                  </p>
                </div>
              </div>
